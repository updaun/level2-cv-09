...
'''
모든 문제를 풀기 위해서 '알고력' & '코딩력' 높이기

1. '알고력' 높이기 위해 알고리즘 공부. 1을 높이기 위해 1의 시간.
2. '코딩력' 높이기 위해 코딩 공부. 1을 높이기 위해 1의 시간.
3. 현재 풀 수 있는 문제 중 하나를 풀어 '알고력'과 '코딩력'을 높인다. 같은 문제 여러 번 푸는 것 가능.

주어진 모든 문제를 풀 수 있는 '알고력'과 '코딩력'을 얻는 최단시간 구하기.
'''
